...
Public Class Xlinked
    ...
    Dim xlinked_pf(20), xlinked_pm(20), delta(20) As Double
    Dim pfList, pmList, deltaList As New PointPairList
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Xlinked))
        ...
        Me.txt_pm.Font = New System.Drawing.Font("Calibri", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.txt_pm.Location = New System.Drawing.Point(68, 48)
        Me.txt_pm.Name = "txt_pm"
        Me.txt_pm.Size = New System.Drawing.Size(64, 22)
        Me.txt_pm.TabIndex = 1
        Me.txt_pm.Text = "0"
        '
        'txt_pf
        '
        Me.txt_pf.Font = New System.Drawing.Font("Calibri", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.txt_pf.Location = New System.Drawing.Point(68, 16)
        Me.txt_pf.Name = "txt_pf"
        Me.txt_pf.Size = New System.Drawing.Size(64, 22)
        ...
        Me.fra_values.Font = New System.Drawing.Font("Calibri", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.fra_values.Location = New System.Drawing.Point(12, 126)
        ...
        'lbl_value7
        '
        Me.lbl_value7.Font = New System.Drawing.Font("Calibri", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        'lbl_value6
        '
        Me.lbl_value6.Font = New System.Drawing.Font("Calibri", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.maingraph.Location = New System.Drawing.Point(264, 12)
        ...
        'chk_delta
        '
        Me.chk_delta.Font = New System.Drawing.Font("Calibri", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.cmd_clear.Location = New System.Drawing.Point(180, 348)
        ...
        Me.cmd_save.Location = New System.Drawing.Point(12, 348)
        ...
        'help_bt
        '
        Me.help_bt.Location = New System.Drawing.Point(725, 426)
        Me.help_bt.Name = "help_bt"
        Me.help_bt.Size = New System.Drawing.Size(75, 23)
        Me.help_bt.TabIndex = 8
        ...
        Me.Name = "Xlinked"
        Me.Text = "X-linked :: random matings"
...
#End Region
    ...
    Private Sub cmd_save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_save.Click
        ...
        With dlg_save
            ...
            If .ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                objWriter.WriteLine("Panmixia - X-linked")
                objWriter.WriteLine("Number of generations : 15")

                objWriter.WriteLine()
                objWriter.WriteLine()
                objWriter.WriteLine("gen." & vbTab & "p(m)" & vbTab & "q(m)" & vbTab & "p(f)" & vbTab & "p2(f)" & vbTab & "2pq(f)" & vbTab & "q2(m)")
                For i = 0 To 15
                    objWriter.WriteLine(i & vbTab & Format(xlinked_pm(i), "0.0000") & vbTab _
                    & Format(1 - xlinked_pm(i), "0.0000") & vbTab & Format(xlinked_pf(i), "0.0000") & vbTab _
                    & Format(xlinked_pf(i) ^ 2, "0.0000") & vbTab & Format(2 * xlinked_pf(i) * (1 - xlinked_pf(i)), "0.0000") _
                    & vbTab & Format((1 - xlinked_pf(i)) * (1 - xlinked_pf(i)), "0.0000"))
                    objWriter.WriteLine()
                Next
                objWriter.Close()
            End If
    ...
    Private Sub help_bt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles help_bt.Click
        System.Diagnostics.Process.Start("http://genedrift.org/popgeneshelp/xlocus.html")
    End Sub
End Class
