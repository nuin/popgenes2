...
Public Class TwoMut
    ...
    Private Sub cmd_ok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_ok.Click
        ...
        'gentorun_mut = Val(txt_gen)
        'If gentorun_mut <> gen Then
        '    MsgBox("Number of genions different from previous run. Screen will be cleared before new plot")
        '    pct_mutation.Cls()
        'End If
        ...
        If Val(txt_rate_m.Text) < 0 Or Val(txt_rate_m.Text) > 1 Then
            ...
            Exit Sub
        End If
        If Val(txt_rate_v.Text) < 0 Or Val(txt_rate_v.Text) > 1 Then
            MsgBox("Mutation rate incorrect", 64, "Mutation")
            txt_rate_v.Text = ""
            txt_rate_v.Focus()
            Exit Sub
