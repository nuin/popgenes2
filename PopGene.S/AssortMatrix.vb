...
Public Class AssortMatrix
    ...
    Private Sub cmd_ok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_ok.Click
        ...
        'pgb_pq.Value = d + h / 2
        'pgb_pq.ToolTipText = "p = " & d + h / 2

        'Call triangle_assortativeD()
        'sst_assortative.Visible = True
        ...
        'Else
        'MsgBox "Please choose an item in the list"
        'End If

        'cmd_cartesian.Enabled = True
        'cmd_equilibrium.Enabled = True
    End Sub
    ...
    Private Sub OvalShape1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OvalShape1.Click, OvalShape9.Click, OvalShape8.Click, OvalShape7.Click, OvalShape6.Click, OvalShape5.Click, OvalShape4.Click, OvalShape3.Click, OvalShape2.Click
